...
describe('Pair', () => {
  const USDC = new Token(ChainId.MAINNET, '0x11bbb41b3e8baf7f75773db7428d5acee25fec75', 18, 'USDC', 'USD Coin')
  const DAI = new Token(ChainId.MAINNET, '0x312b15d6d531ea0fe91ddd212db8c0f37e4cc698', 18, 'DAI', 'DAI Stablecoin')
